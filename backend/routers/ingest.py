...
def ingest_metric_data(
    ...
    # Retiro de `Nombre_Norm` (2026-08-07): la ingesta ya no genera el par
    # X/X_Norm. Se guardan solo las dimensiones que el integrador manda; la
    # identidad de lectura se calcula al vuelo con `normalizar_nombre`.
